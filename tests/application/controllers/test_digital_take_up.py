...
class UploadOptionsPageTestCase(FlaskAppTestCase):
    ...
    @patch("performanceplatform.client.admin.AdminAPI.get_dashboard",
           return_value={})
    def test_upload_options_slug_renders_upload_options_page(
            self,
            mock_get_dashboard):
        response = self.client.get(
            '/dashboard/dashboard-uuid/digital-take-up/upload-options')
    ...
    @patch("performanceplatform.client.admin.AdminAPI.get_dashboard",
           return_value={})
    def test_upload_option_field_is_required(self, mock_get_dashboard):
    ...
    @patch("performanceplatform.client.admin.AdminAPI.get_dashboard",
           return_value={})
    def test_stores_chosen_option_in_the_session(self, mock_get_dashboard):
        self.client.post(
            '/dashboard/dashboard-uuid/digital-take-up/upload-options',
            data=self.params())
    ...
    @patch("performanceplatform.client.admin.AdminAPI.get_dashboard",
           return_value={})
    def test_redirects_to_channel_options_page(self, mock_get_dashboard):
        response = self.client.post(
            '/dashboard/dashboard-uuid/digital-take-up/upload-options',
            data=self.params())
        assert_that(response.status, equal_to('302 FOUND'))
    ...
    @patch("performanceplatform.client.admin.AdminAPI.get_dashboard",
           return_value={})
    def test_api_choice_redirects_to_api_get_in_touch_page(
...
class ChannelOptionsPageTestCase(FlaskAppTestCase):
    ...
    @patch('performanceplatform.client.admin.AdminAPI.get_dashboard',
           return_value={})
    def test_channel_options_slug_renders_channel_choices_page(
            self, mock_get_dashboard):
        response = self.client.get(
            '/dashboard/dashboard-uuid/digital-take-up/channel-options')
        assert_that(response.status, equal_to('200 OK'))
    ...
    @patch('performanceplatform.client.admin.AdminAPI.get_dashboard',
           return_value={})
    def test_one_or_more_channel_options_are_required(
            self, mock_get_dashboard):
        response = self.client.post(
            '/dashboard/dashboard-uuid/digital-take-up/channel-options',
            data={})
    ...
    def test_transform_created(
        ...
        get_transform_types_patch.return_value = [{
            'name': 'rate',
            'id': 'qwerty123'
        }]
...
class DownloadTemplatePageTestCase(FlaskAppTestCase):
    ...
    @patch('performanceplatform.client.admin.AdminAPI.get_dashboard',
           return_value={})
    def test_download_slug_renders_download_template_page(
            self, mock_get_dashboard):
        response = self.client.get(
            '/dashboard/dashboard-uuid/digital-take-up/upload')
        assert_that(response.status, equal_to('200 OK'))
    ...
    @patch('performanceplatform.client.admin.AdminAPI.get_dashboard',
           return_value={})
    def test_serves_a_weekly_csv_file_for_chosen_channels(
            self, mock_get_dashboard):
        with self.client.session_transaction() as session:
            session['upload_choice'] = 'week'
            session['channel_choices'] = ['api', 'face_to_face']
    ...
    @patch('performanceplatform.client.admin.AdminAPI.get_dashboard',
           return_value={})
    def test_serves_a_monthly_csv_file_for_chosen_channels(
            self, mock_get_dashboard):
        with self.client.session_transaction() as session:
...
class UploadPageTestCase(FlaskAppTestCase):
    ...
    def test_upload_slug_renders_digital_take_up_upload_page(
            self, mock_get_dashboard, client):
