...
def get_or_create_data_set_transform(
        admin_client, uuid, transform_config, data_set, transform_type_name):
    ...
    if not transform:
        transform_types = admin_client.get_transform_types()

        for transform_type in transform_types:
            if transform_type['name'] == transform_type_name:
                transform_config["type_id"] = transform_type['id']
